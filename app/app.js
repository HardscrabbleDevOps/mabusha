...
jQuery( window ).scroll(function() {
   if ($(window).scrollTop()  > 90) {
         $( ".hsHeader-fxd" ).css( "top", "0" );
     } else {

        $( ".hsHeader-fxd" ).css( "top", "-14%" );
    }
...
jQuery(".services").click(function() {
    jQuery('html,body').stop().animate({
        scrollTop: jQuery(".divServices").offset().top - 65},
        1500);
});
jQuery(".support").click(function() {
    jQuery('html,body').stop().animate({
        scrollTop: jQuery(".divSupport").offset().top - 65},
        1500);
});
jQuery(".contact").click(function() {
    jQuery('html,body').stop().animate({
        scrollTop: jQuery(".divContact").offset().top - 65},
        1500);
});
...
// =====================================================
 ...
 setTimeout(function () {
     jQuery('html,body').stop().animate({ scrollTop: jQuery("html,body").offset().top}, 50);
     // jQuery('.construction').fadeOut('slow');
 }, 3000);
